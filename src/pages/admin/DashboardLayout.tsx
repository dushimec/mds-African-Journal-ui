...
const Sidebar: React.FC<SidebarProps> = ({ isOpen, toggle }) => {
  ...
  const menus = [
    ...
    { name: "Authors", path: "/dashboard/authors", icon: <Users size={18} /> },
    { name: "Author Content", path: "/dashboard/author-content", icon: <FileText size={18} /> },
    { name: "Author Page", path: "/dashboard/author-page", icon: <FileText size={18} /> },
